...
const AddExctvsForm = ({ togglePopup }: { togglePopup: () => void }) => {
    ...
    const toggleAccordion = (_: any, index: number) => {
        setSelectedAccordion(selectedAccordion === index ? null : index);
    };

    return (
        <div className="add-exctvs-for add-popup-window">
            ...
            <div className="add-exctvs-form-head">
                <div className="add-exctvs-form-controller">
                    <div className="add-exctvs-form-inputs">
                        <div>
            ...
            <div className="accordion-settings-wrapper">
                {accordian_settings.map((item, index) => (
                    <Accordion
                        ...
                        item={item}
                        toggleAccordion={() => toggleAccordion(item, index)}
                    />
                ))}
            </div>
...
const Accordion = ({ index, isOpen, toggleAccordion, item }: { item: any; index: number, isOpen: boolean, toggleAccordion: () => void }) => {
    const contentRef: any = useRef(null);

    return (
        <div className="accordion-settings">
            <div className="accordion-settings-title" onClick={toggleAccordion}>
            ...
            >
                <form>
                    {
                        item.settings.map((settings: string[], i: number) => {
                            return (
                                <div key={i} className="radio-inputs-wrapper">
                                    <p>{settings}</p>
                                    <div className="radio-inputs">
                                        <span>
                                            <input type="radio" name={`option-${index}`} id="" />
