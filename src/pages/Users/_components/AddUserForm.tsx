...
const AddUserForm = ({ togglePopup }: { togglePopup: () => void }) => {
    ...
    const handleAccountTypeChange = (type: 'Demo' | 'Live') => {
        setNewUser(prev => ({ ...prev, server_type: type }));
    };
    ...
    return (
        <div className="add-user-for add-popup-window" >
                ...
                <div className="add-user-form-controller" >
                    ...
                    <div className="account-type" >
                        <button
                            ...
                            className={newUser.server_type === 'Demo' ? 'active' : ''}
                        >Demo</button>
                        <button
                            onClick={() => handleAccountTypeChange('Live')}
                            className={newUser.server_type === 'Live' ? 'active' : ''}
                        >Live</button>
                    </div>
                </div>
            ...
            <form className="add-user-form-box" onSubmit={handleSubmit} >
                <div className="add-user-form-inputs">
                    ...
                    <div>
                        ...
                        <select name="country" value={newUser.country} onChange={handleInputChange} >
                            <option value={"India"}>Country 1</option>
                            <option value={"UAE"}>Country 2</option>
                            <option value={"UK"}>Country 3</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        <label htmlFor="">Account Plan</label>
                        <select name="account_plan" value={newUser.account_plan} onChange={handleInputChange}>
                    ...
                    <div>
                        ...
                        <select name="amount" value={newUser.amount} onChange={handleInputChange}>
                    ...
                    <div>
                        ...
                        <select name="leverage" value={newUser.leverage} onChange={handleInputChange}>
                    ...
                    <div>
                        <label htmlFor="">Bonus Card (If Any)</label>
                        <input
                            onChange={handleInputChange}
                            name="bonus_card"
                            type="number" placeholder="Enter Bonus Card" />
                    </div>
                </div>
