...
const AddPermsnForm = ({ togglePopup }: { togglePopup: () => void }) => {
    ...
    return (
        <div className="add-permsn-for add-popup-window">
            ...
            <div className="add-permsn-form-head">
                <div className="add-permsn-form-controller">
                    <div className="add-permsn-form-inputs">
                        <div>
