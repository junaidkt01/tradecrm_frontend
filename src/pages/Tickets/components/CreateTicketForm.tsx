...
const CreateTicketForm = ({ togglePopup }: { togglePopup: () => void }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const { department, subject, message, query_type, priority, created_by } = formData;

        if (!department || !subject || !message || !query_type || !priority || !created_by) {
            alert("Please fill in all fields.");
            return;
        }
            ...
            <form className="add-user-form-box" onSubmit={handleSubmit} >
                <div className="add-user-form-inputs">
                    ...
                    <div>
                        ...
                        <select required name="query_type" value={formData.query_type} onChange={handleInputChange} >
                            <option>Choose</option>
