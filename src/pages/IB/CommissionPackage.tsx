...
import { CommissionPackageTable } from "../../components/IbAndSubIbTable/IbAndSubIbTable";
import { commissionPackage } from "../../utils/IbAndSubIbTable";
...
const CommissionPackage = () => {
    ...
    return (
        <div className='commission-package pages-wrapper' >
            <Breadcrumbs title="IB / Commission Package" />
            ...
            <CommissionPackageTable tableData={commissionPackage} />
        </div>
    )
}
