...
import { sharingPlan } from "../../utils/SharingPlan";
import { SharingPlanTable } from "../../components/SharingTable/SharingTable";
...
const SharingPlan = () => {
    ...
    return (
        <div className="sharing-plan pages-wrapper" >
            <Breadcrumbs title="IB / Sharing Plan" />
            <div className="table-control-btns">
                ...
                <div className="add-executives-btns">
                    <button onClick={togglePopup} >
                        ...
                        <span>Add Sharing Plan</span>
                    </button>
                </div>
            </div>
            <SharingPlanTable tableData={sharingPlan} />
        </div>
    )
}
