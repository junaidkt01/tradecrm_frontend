...
import AddPackagesAccordion from "./AddPackagesAccordion";
import { Package, usePackages } from "../../../../Hooks/usePackages";

const AddPackagesForm = ({ togglePopup, data }: { togglePopup: () => void; data: Package | undefined }) => {
    ...
    const handleFormSubmit = async (e: any) => {
        ...
        const mutation = data ? updatePackage : addPackage;
    ...
    return (
        <form onSubmit={handleFormSubmit} className="add-works-space-for add-popup-window" >
            ...
            <div>
                <p>Package Type</p>
                <div className="packages-radio" style={{ display: "flex", margin: "18px 0", gap: "10px" }} >
                    <div>
                        <input
                            type="radio"
                            name="package_type"
                            id="investment"
                            value="Investment"
                            checked={formData?.package_type === "Investment"}
                    ...
                    <div>
                        <input
                            ...
                            id="trading"
                            value="Trading"
                            checked={formData?.package_type === "Trading"}
                            onChange={handleInputChange}
                            required
                        />
                        <label htmlFor="">Trading</label>
                    </div>
                </div>
            </div>

            <div className="confiq-accordion-wrapper" >
                <AddPackagesAccordion
                    title={"Package"}
                >
                    <div className="package-inputs-form" >
                        <div className="package-inputs-container" >
                            <div>
                                <label htmlFor="">Package Name</label>
                                <input onChange={handleInputChange} value={formData?.package_name} name="package_name" required type="text" placeholder="Enter Package name" />
                            </div>
                            <div>
                                <label htmlFor="">Manager</label>
                                <select required name="manager_id" value={formData?.manager_name} onChange={handleInputChange} >
                            ...
                            <div>
                                ...
                                <select required name="group_id" value={formData?.group_id} onChange={handleInputChange} >
                                    <option>Choose</option>
                                    <option value={1}>Technical</option>
                                    <option value={2}>Account</option>
                                    <option value={3}>Compliance</option>
                            ...
                            <div>
                                <label htmlFor="">Max. Leverage</label>
                                <select required name="max_leverage" value={formData?.max_leverage} onChange={handleInputChange} >
                                    <option>Choose</option>
                                    <option value={1}>Technical</option>
                                    <option value={2}>Account</option>
                                    <option value={3}>Compliance</option>
                ...
                >
                    <div className="package-inputs-form" >
                        <div className="package-inputs-container" >
                            <div>
                                <label htmlFor="">Min. Deposite</label>
                                <input onChange={handleInputChange} name="min_deposit" value={formData?.min_deposit} required type="number" placeholder="0" />
                            </div>
                            <div>
                                <label htmlFor="">Max. Deposite</label>
                                <input onChange={handleInputChange} name="max_deposit" value={formData?.max_deposit} required type="number" placeholder="0" />
                            </div>

                            <div className="packages-checkbox">
                                <div>
                                    <input
                                        type="checkbox"
                                        name="deposit_first_time"
                                        id="deposit_first_time"
                                        checked={formData?.deposit_first_time}
                                        onChange={handleInputChange}
                                    />
                                    <label htmlFor="deposit_first_time">Deposit First Time</label>
                                </div>
                                <div>
                                    <input
                                        type="checkbox"
                                        name="every_time"
                                        id="every_time"
                                        checked={formData?.every_time}
                                        onChange={handleInputChange}
                                    />
                                    <label htmlFor="every_time">Every Time</label>
                                </div>
                            </div>
                            {formData?.package_type === "Investment" && <div>
                                <label htmlFor="">Investment Fee %</label>
                                <input onChange={handleInputChange} value={formData?.investment_fee} name="investment_fee" required type="number" placeholder="0" />
                            </div>}
                            {formData?.package_type === "Trading" && <div>
                                <label htmlFor="">Deposit Fee %</label>
                                <input onChange={handleInputChange} value={formData?.deposit_fee} name="deposit_fee" required type="number" placeholder="0" />
                            </div>}
                            <div>
                                <label htmlFor="">Locking Period</label>
                                <input onChange={handleInputChange} value={formData?.locking_period} name="locking_period" required type="number" placeholder="0" />
                            </div>
                            <div style={{ display: "flex", flexDirection: "column" }} >
                                <label htmlFor="">Withdraw Type</label>
                                <select required name="withdraw_type" value={formData?.withdraw_type} onChange={handleInputChange} >
                                    <option>Choose</option>
                                    <option value={"Only Profit"} >Only Profit</option>
                                    <option value={"Full Withdraw"} >Full Withdraw</option>
                                </select>
                            </div>

                            <div className="packages-radio">
                                <p>Withdraw Fee (Account to Wallet) %</p>
                                <div>
                                    <input
                                        type="radio"
                                        ...
                                        id="by_amount"
                                        value="By Amount"
                                        checked={formData?.withdraw_fee_type === "By Amount"}
                                        onChange={handleInputChange}
                                        required
                                    />
                                    <label htmlFor="by_amount">By Amount</label>
                                </div>
                                <div>
                                    <input
                                        type="radio"
                                        ...
                                        id="on_profit"
                                        value="On Profit"
                                        checked={formData?.withdraw_fee_type === "On Profit"}
                                        onChange={handleInputChange}
                                        required
                                    />
                                    <label htmlFor="on_profit">On Profit</label>
                                </div>
                                <input
                                    onChange={handleInputChange}
                            ...
                            {formData?.package_type === "Investment" && <div>
                                <label htmlFor="">Admin Fee %</label>
                                <input onChange={handleInputChange} value={formData?.admin_fee} name="admin_fee" required type="number" placeholder="0" />
                            </div>}
                        </div>
                    </div>
                </AddPackagesAccordion>
                    ...
                    <div className="package-inputs-form" >
                        <div className="package-inputs-container" >
                            <div style={{ display: "flex", flexDirection: "column" }} >
                                ...
                                <select required name="bonus_id" value={formData?.bonus_id} onChange={handleInputChange} >
                                    <option>Choose</option>
                                    <option value={12}>Technical</option>
                                    <option value={13}>Account</option>
                                    <option value={14}>Compliance</option>
                                    <option value={17}>Subscription</option>
                                </select>
                            </div>
                            <div style={{ display: "flex", flexDirection: "column" }} >
                                <label htmlFor="">Plan Flow</label>
                                <select required name="plan_flow" value={formData?.plan_flow} onChange={handleInputChange} >
                                    <option>Choose</option>
                                    <option value={1}>Technical</option>
                                    <option value={2}>Account</option>
                                    <option value={3}>Compliance</option>
                                ...
                                <p>Please select any plan flow to get INFO.</p>
                            </div>
                            <div>
                                <label htmlFor="">Promotion Tips</label>
                                <input onChange={handleInputChange} value={formData?.promotion_tips} name="promotion_tips" required type="text" placeholder="Promotion Tips" />
                            </div>
                            <div>
                                <label htmlFor="">Comment</label>
                                <textarea onChange={handleInputChange} value={formData?.comment} name="comment" style={{ width: "90%" }} placeholder="Comment" />
                            </div>
                        </div>
                    </div>
                </AddPackagesAccordion>
                            ...
                            <div className="packages-radio" >
                                ...
                                <div>
                                    <input
                                        ...
                                        value="demo"
                                        name="account_type"
                                        checked={formData?.account_type === "demo"}
                                        onChange={handleInputChange}
                                    />
                                    <label htmlFor="account-type-1">Demo</label>
                                </div>
                                <div>
                                    <input
                                        required
                                        ...
                                        value="live"
                                        name="account_type"
                                        checked={formData?.account_type === "live"}
                                        onChange={handleInputChange}
                                    />
                                    <label htmlFor="account-type-1">Live</label>
                                </div>
                            </div>
                            ...
                            <div className="packages-checkbox" >
                                ...
                                <div>
                                    <input
                                        ...
                                        required
                                    />
                                    <label htmlFor="">Allow Deposit</label>
                                </div>
                                <div>
                                    <input
                                        type="checkbox"
                                        ...
                                        required
                                    />
                                    <label htmlFor="">Allow Withdraw</label>
                                </div>
                            </div>
                            <div>
                                <label htmlFor="">Max Account Open</label>
                                <input onChange={handleInputChange} value={formData?.max_account_open} name="max_account_open" required type="number" placeholder="0" />
                            </div>
                        </div>
                    </div>
                </AddPackagesAccordion>
