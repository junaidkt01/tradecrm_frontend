...
const BonusCard = ({ data, onButtonClick }: { data: BonusType; onButtonClick: (method: string, bonus?: BonusType) => void; }) => {
            ...
            <div className="bonus-card-top" >
                <div className="title">
                    ...
                    <div style={{ position: 'relative' }} >
                        <div className="card-menu-icon" onClickCapture={handleClick} >
                ...
                <div className="bonus-card-content" >
                    <p>Bonus ID: <strong>{data.id}</strong></p>
                </div>
            </div>
        </div>
    )
